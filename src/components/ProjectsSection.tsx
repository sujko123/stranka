...
const projects: Project[] = [
  { id: "secret-menu", title: "Secret Menu", image: secretMenu, description: text("Platformu sme vytvorili spolu s kamarátom ako interné riešenie pre spoločnosť. Slúži na tvorbu digitálnych menu, správu ponuky a zákazníckych interakcií.", "A friend and I built this platform as an internal solution for a company. It supports digital menu creation, offer management and customer interactions."), stack: ["Next.js", "TypeScript", "Fastify", "PostgreSQL", "Prisma", "Resend", "Render", "UI/UX"], status: "live", category: "platform" },
